...
const safeCodes = new Set([
  ...
  'BRIDGE_MESSAGE_UNAVAILABLE', 'BRIDGE_PROMPT_AMBIGUOUS', 'BRIDGE_CANCEL_TARGET_CHANGED', 'BRIDGE_BINDING_LIMIT', 'BRIDGE_PREPARATION_REJECTED', 'BRIDGE_INTENT_REJECTED', 'BRIDGE_EMPTY_PROMPT', 'BRIDGE_INVALID_INPUT', 'BRIDGE_INVALID_SKILL', 'BRIDGE_UNKNOWN_ROLE',
