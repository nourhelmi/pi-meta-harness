---
name: cos
description: Opt into a workstream-lifetime team of empowered outcome owners using this host's native tools and the shared advisor checkpoint.
---
# Native CoS entry
...
in any order. Native messaging/continuity guarantees are only those the current
host actually exposes. `$cos` is Codex skill invocation; Claude Code uses `/cos`.
