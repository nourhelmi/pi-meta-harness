...
- `pi-better-edit` is the exact-pinned primary hash-anchored read/edit/undo package recorded in `config/third-party-extensions.lock.json` and retains its upstream MIT license.
