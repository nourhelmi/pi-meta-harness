...
- `pi-ui-pack`, `@ogulcancelik/pi-codex-compaction`, and `pi-mermaid` are installed from the exact sources recorded in `config/third-party-extensions.lock.json`. They retain their upstream MIT licenses.
